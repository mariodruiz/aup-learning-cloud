...
AUP Learning Cloud provides four hands-on toolkits that cover the major areas of modern AI and robotics, all running on AMD GPU acceleration. Each toolkit is a series of progressive Jupyter notebook labs, no prior GPU setup required. Pick the one that matches your interest and start building.

::::{grid} 2
:gutter: 3

:::{grid-item-card} Computer Vision (8 labs)
:link: computer-vision
:link-type: doc
:img-top: ../_static/images/teaching_solution_img/CV_01.png
...
:::{grid-item-card} Deep Learning (12 labs)
:link: deep-learning
:link-type: doc
:img-top: ../_static/images/teaching_solution_img/DL_01.png
...
:::{grid-item-card} Large Language Model from Scratch (14 labs)
:link: llm-from-scratch
:link-type: doc
:img-top: ../_static/images/teaching_solution_img/LLM_01.jpg
...
:::{grid-item-card} Physics Simulation (4 labs)
:link: physics-simulation
:link-type: doc
:img-top: ../_static/images/teaching_solution_img/PhySim_06_parallel.png
